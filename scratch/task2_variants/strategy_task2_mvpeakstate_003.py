# Local sweep variant: peak-state DP peak_points=49 demand=0.5 diesel=1000
...
class Strategy:
    ...
    def _plan_next_soc(
        ...
        *,
        ...
        peak_levels = np.linspace(0.0, costs.grid_max_import_mw, 49)
