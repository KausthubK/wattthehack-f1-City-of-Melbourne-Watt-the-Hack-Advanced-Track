# Local sweep variant: midday surplus floor 0.95
...
class Strategy:
    ...
    def _reserve_soc_floor(self, state: dict[str, Any], t: int) -> float:
        ...
        if scenario_id == "frequency_frenzy" and 36 <= time_of_day <= 62 and float(state.get("solar", 0.0)) > float(state.get("demand", 0.0)):
            return 0.95
