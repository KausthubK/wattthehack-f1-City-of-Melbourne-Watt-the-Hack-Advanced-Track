# Local sweep variant: Round 1 value function strategy_task1_mvround1_value005.py
# future_value=$350/MWh window=74-84
...
class Strategy:
    ...
    def future_energy_value(
        ...
        if time_of_day < 74:
            ...
            remaining = max(1, 84 - time_of_day + 1)
            full_window = max(1, 84 - 74 + 1)
            urgency = remaining / full_window

        return -deliverable_mwh * 350.0 * urgency
