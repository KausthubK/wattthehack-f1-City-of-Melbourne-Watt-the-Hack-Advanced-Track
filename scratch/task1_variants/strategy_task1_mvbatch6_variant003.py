# Local sweep variant: batch6 prior-day aggressive reserve
...
class Strategy:
    ...
    def generate_candidate_actions(self, state: dict[str, Any]) -> list[dict[str, float]]:
        ...
        should_discharge = (
            price >= 430.0
            or self.prior_day_peak_hint(state) >= 410.0
    ...
    def desired_soc_floor(self, state: dict[str, Any]) -> float:
        ...
        if 55 <= time_of_day <= 70 and self.prior_day_future_peak_hint(state) >= 410.0:
            return 0.30
