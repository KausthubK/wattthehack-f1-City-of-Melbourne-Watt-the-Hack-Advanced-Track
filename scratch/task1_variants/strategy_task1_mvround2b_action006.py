# Local sweep variant: Round 2b action menu 2.5MW steps + target imports 95/100/102
    ...
    def generate_candidate_actions(self, state: dict[str, Any]) -> list[dict[str, float]]:
        ...
        if deficit_mw > 0.0 and soc > 0.05 and should_discharge:
            ...
            discharge_candidates = {
                    min(discharge_cap_mw, 2.5),
                    min(discharge_cap_mw, 5.0),
                    min(discharge_cap_mw, 7.5),
                    min(discharge_cap_mw, 10.0),
                    min(discharge_cap_mw, 12.5),
                    min(discharge_cap_mw, 15.0),
                    min(discharge_cap_mw, 17.5),
                    min(discharge_cap_mw, 20.0),
                    min(discharge_cap_mw, 22.5),
                    min(discharge_cap_mw, 25.0),
                    min(discharge_cap_mw, 27.5),
                    min(discharge_cap_mw, 30.0),
                    min(discharge_cap_mw, 32.5),
                    min(discharge_cap_mw, 35.0),
                    min(discharge_cap_mw, 37.5),
                    min(discharge_cap_mw, 40.0),
                    min(discharge_cap_mw, 42.5),
                    min(discharge_cap_mw, 45.0),
                    min(discharge_cap_mw, 47.5),
                    min(discharge_cap_mw, 50.0),
                    min(discharge_cap_mw, deficit_mw),
                }

            for target_import_mw in (95.0, 100.0, 102.0,):
