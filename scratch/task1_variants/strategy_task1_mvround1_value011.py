# Local sweep variant: Round 1 value function strategy_task1_mvround1_value011.py
# future_value=$550/MWh window=76-82
...
class Strategy:
    ...
    def future_energy_value(
        ...
        if time_of_day < 76:
            ...
            remaining = max(1, 82 - time_of_day + 1)
            full_window = max(1, 82 - 76 + 1)
            urgency = remaining / full_window

        return -deliverable_mwh * 550.0 * urgency
