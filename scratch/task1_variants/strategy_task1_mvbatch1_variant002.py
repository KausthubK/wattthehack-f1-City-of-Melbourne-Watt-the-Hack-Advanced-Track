# Local sweep variant: batch1 price=430 buffer=15 cap=1.60
...
class Strategy:
    ...
    def generate_candidate_actions(self, state: dict[str, Any]) -> list[dict[str, float]]:
        ...
        should_discharge = (
            price >= 430.0
            or pre_action_import_mw >= costs.grid_max_import_mw - 15.0
        )
    ...
    def discharge_cap_for_peak(self, state: dict[str, Any], soc: float) -> float:
        ...
        return self._clip(1.60 * sustainable_mw, 10.0, costs.max_inverter_mw)
