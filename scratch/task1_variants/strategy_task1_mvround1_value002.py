# Local sweep variant: Round 1 value function strategy_task1_mvround1_value002.py
# future_value=$450/MWh window=67-86
...
class Strategy:
    ...
    def future_energy_value(
        ...
        if time_of_day < 67:
            ...
            remaining = max(1, 86 - time_of_day + 1)
            full_window = max(1, 86 - 67 + 1)
            urgency = remaining / full_window

        return -deliverable_mwh * 450.0 * urgency
